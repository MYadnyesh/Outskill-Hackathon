...
export const demoTldr = {
  ...
  tldr: {
    ...
    topics: [
      { name: 'Black holes', note: 'Formed when massive stars collapse under their own gravity at the end of their lives.' },
      { name: 'Event horizon', note: 'The boundary past which nothing escapes — the reason black holes are invisible.' },
      { name: 'Gravity', note: 'Strong enough here to trap light itself, which no other object achieves.' },
      { name: 'Supermassive', note: 'The largest kind sit at the centres of most galaxies, including the Milky Way.' },
      { name: 'Detection', note: 'Found indirectly, by watching how nearby stars and gas move around them.' },
    ],
