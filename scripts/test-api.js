...
//
// If GEMINI_API_KEY isn't set, the 'tldr', 'song', and 'kid' cases are all
// expected to fail with AI_ERROR — that's a PASS for this script (it proves
// error handling works), not a real failure. Set GEMINI_API_KEY in your
// shell to test the real path.
//
